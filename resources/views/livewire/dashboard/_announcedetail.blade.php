        ...
        <div class="md:grid md:grid-cols-3 md:gap-6 ">
            ...
            <div class="mt-5 md:mt-0 md:col-span-3 ">
                <div class="overflow-hidden shadow sm:rounded-md">
                    <div class="px-4 py-5 space-y-6 bg-orange-100 sm:p-6 dark:bg-neutral-800">
                        <div class="grid grid-cols-4 gap-4">
                            <div class="col-span-4 mt-2 sm:col-span-4">
                                <label class="py-4 block text-lg font-medium text-gray-900 dark:text-neutral-300 ">
                                    หัวข้อ 
                                ...
                                <div class="pl-4 text-base dark:text-neutral-300">
                                    {{$announcement_header ?? ''}}
                                </div>
                            </div>
                            <div class="col-span-4 mt-2 sm:col-span-4">
                    ...
                    <div class="px-4 py-3 text-left bg-gray-50 sm:px-6 dark:bg-neutral-700">
                        <section class="overflow-hidden text-gray-700 ">
                            <div class="container px-5 py-2 mx-auto lg:pt-2 lg:px-2">
                                <label class=" text-lg font-medium text-gray-900 dark:text-neutral-300 ">ภาพวีดีโอตัวอย่าง </label>
                        ...
                        <section class="overflow-hidden text-gray-700 ">
                            <div class="container px-5 py-2 mx-auto lg:pt-12 lg:px-2">
                                <label class=" text-lg font-medium text-gray-900 dark:text-neutral-300 ">ภาพตัวอย่าง </label>
                                <div class="flex flex-wrap -m-1 md:-m-2">
                                    @foreach ($gallery as $item)
                                        {{-- {{dd($gallery)}} --}}
                                        @if ($item->file_type != 'mp4')
