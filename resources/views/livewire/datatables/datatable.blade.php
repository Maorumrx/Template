    ...
    <div class="relative ">
        <div class="flex items-center justify-between mb-1 ">
            ...
            <div class="flex flex-wrap items-center space-x-1 ">
                ...
                @if($this->activeFilters)
                    <button wire:click="clearAllFilters" class="flex items-center px-3 space-x-2 text-xs font-medium leading-4 tracking-wider text-red-500 uppercase bg-white border border-red-400 rounded-md hover:bg-red-200 focus:outline-none"><span>{{ __('Reset') }}</span>
                ...
                @if(count($this->massActionsOptions))
                    <div class="flex items-center justify-center space-x-1">
                        ...
                        <select wire:model="massActionOption" class="px-3 space-x-2 text-xs font-medium leading-4 tracking-wider uppercase bg-white border border-green-400 rounded-md focus:outline-none" id="datatables_mass_actions">
                        ...
                        <button
                            ...
                            class="flex items-center px-4 py-2 text-xs font-medium leading-4 tracking-wider text-green-500 uppercase bg-white border border-green-400 rounded-md hover:bg-green-200 focus:outline-none" type="submit" title="Submit"
                        >Go</button>
                    </div>
                @endif
                ...
                <div class="items-center justify-between p-2 sm:flex">
                    ...
                    @if(count($this->results))
                        <div class="flex items-center my-2 sm:my-0">
                            <select name="perPage" class="block w-full py-2 pl-3 pr-10 mt-1 text-base leading-6 border-gray-300 rounded-lg dark:bg-neutral-700 dark:text-neutral-300 dark:border-neutral-600 dark:hover:border-neutral-600 form-select focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:ring-0 sm:text-sm sm:leading-5" wire:model="perPage">
                        ...
                        <div class="flex justify-end text-sm text-gray-600 dark:text-neutral-300">
