        ...
        <div class="md:grid md:grid-cols-3 md:gap-6 ">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <div class=" text-sm text-center group">
                                    ...
                                    @foreach ($gallery as $item)
                                        ...
                                        @if ($item->file_type == 'mp4')
                                            <div class="flex flex-wrap w-full">
                                                ...
                                                <video controls autoplay loop muted class="block object-cover object-center w-full h-full rounded-lg" >
                    ...
                    <div class="px-4 py-5 space-y-6 bg-white sm:p-6 dark:bg-neutral-800">
                        <div class="grid grid-cols-4 gap-4">
                                            ...
                                            <div class="space-y-1 text-center">
                                                ...
                                                x-on:livewire-upload-progress="progress = $event.detail.progress" >
                                                    <div class="flex text-sm text-gray-600">
                                                        <label for="file-upload" class="relative font-medium text-indigo-600 bg-white rounded-md cursor-pointer ">
                                                            ...
                                                            <input id="file-upload" wire:model="image_file" name="file-upload" type="file" class="sr-only" 
                                                                multiple enctype="multipart/fprm-data" accept="video/*">
                            ...
                            <div class="col-span-4 mt-2 sm:col-span-2">
                                ...
                                <input type="text" wire:model.defer="moralize_name"
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                                @error('moralize_name') <span class="text-red-500 error-message">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-span-4 mt-2 sm:col-span-2">
                                <label class="block text-sm font-medium text-gray-900 dark:text-neutral-300 ">รายละเอียด</label>
                                <textarea rows="3" wire:model.defer="moralize_desc"
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    placeholder="">
                                </textarea>
                                @error('moralize_desc') <span class="text-red-500 error-message">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
