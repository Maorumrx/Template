...
class Moralizedatatable extends LivewireDatatable
{
    ...
    public function columns()
    {
        return [
            ...
            //     ->alignCenter()
            //     ->label('ปักหมุด'),
            Column::name('moralize_name')
            ->label('หัวข้อ')
                ->alignCenter()
                ->searchable(),
            Column::name('moralize_desc')
            ->label('รายละเอียด')
            ->truncate()
                ->searchable(),
            ...
            //     ->alignCenter()
            //     ->label('สถานะ'),
            Column::callback(['moralizes.moralize_id'], function ($id) {
